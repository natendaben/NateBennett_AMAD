...
class RangeInfoTableViewController: UITableViewController {
    ...
    @IBOutlet weak var totalMountainsLabel: UILabel!
    @IBOutlet weak var mountainsClimbedLabel: UILabel!
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        totalMountainsLabel.text = totalMountains
        mountainsClimbedLabel.text = mountainsClimbed
