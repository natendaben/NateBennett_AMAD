...
class EditStreakFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        (activity as AppCompatActivity?)?.supportActionBar?.title = "Edit Habit"
        ...
        val root = inflater.inflate(R.layout.fragment_edit_streak, container, false)
    ...
    private fun addNewHabit(){
        if(nameEditText.text.toString() != "" && categoryEditText.text.toString() != ""){
            //get info from UI elements
            val newName = nameEditText.text.toString()
            val newCategory = categoryEditText.text.toString()
            val newColor = selectedColor.value ?: "yellow"

            //update habit in database
            viewModel.updateStreakInfoFromUI(
                currentHabit.id,
                newName,
                newCategory,
                newColor
            ...
            viewModel.currentHabit.value?.name = newName
            viewModel.currentHabit.value?.category = newCategory
            viewModel.currentHabit.value?.color = newColor

            navController.navigateUp()
            val text = "Habit edited successfully!"
